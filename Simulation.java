...
public class Simulation
{
        ...
        // No graphics, just text
        {
            ...
            for (int i = 0; i < theField.getHeight(); i++)
            {
                ...
                for (int j = 0; j < theField.getWidth(); j++)
                {
                    if (theField.isOccupied(j, i))
                    {
                        System.out.print(theField.getCellAt(j, i)
                                .getOccupant() + "|");
                    } else
                    {
                        System.out.print(" |");
    ...
    public static void main(String[] args)
    {
         ...
         * --graphics for "graphics" mode --width 999 to set the "width"
         * --height 999 to set the height --starvetime 999 to set the
         * "starve time" --fox 0.999 to set the "fox probability" --hound 0.999
         * to set the "hound probability"
         */
        ...
        for (int i = 0; i < theField.getWidth(); i++)
        {
            ...
            {
                // If a random number is greater than or equal to the
                // probability
                ...
                if (randomGenerator.nextGaussian() <= probabilityFox)
                {
                    ...
                    theField.setCellAt(i, j, tempCell);
                }
                ...
                {
                    theField.setCellAt(i, j, new Cell(i, j));
                }

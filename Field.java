 ...
 */
// Field should be an inert object that is the state of the simulation
// Needs to be shared safely among all active entities
// Will answer questions about entities neighbors
